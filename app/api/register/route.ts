...
export async function POST(req: Request) {
  ...
  try {
    ...
    const uid = uuidv4();
    const role = email === 'jeanbernardpierrelouis@gmail.com' ? 'admin' : 'user';
    ...
    await query(
      ...
      [
        ...
        JSON.stringify(offeredSkills), JSON.stringify(requestedSkills), avatar, true, role
      ]
    );
