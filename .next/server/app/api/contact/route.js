"use strict";(()=>{var e={};e.id=386,e.ids=[386],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},8678:e=>{e.exports=import("pg")},83041:(e,t,s)=>{s.a(e,async(e,r)=>{try{s.r(t),s.d(t,{originalPathname:()=>u,patchFetch:()=>T,requestAsyncStorage:()=>R,routeModule:()=>n,serverHooks:()=>l,staticGenerationAsyncStorage:()=>d});var E=s(73278),a=s(45002),o=s(54877),i=s(32043),A=e([i]);i=(A.then?(await A)():A)[0];let n=new E.AppRouteRouteModule({definition:{kind:a.x.APP_ROUTE,page:"/api/contact/route",pathname:"/api/contact",filename:"route",bundlePath:"app/api/contact/route"},resolvedPagePath:"P:\\boursedutemps\\app\\api\\contact\\route.ts",nextConfigOutput:"",userland:i}),{requestAsyncStorage:R,staticGenerationAsyncStorage:d,serverHooks:l}=n,u="/api/contact/route";function T(){return(0,o.patchFetch)({serverHooks:l,staticGenerationAsyncStorage:d})}r()}catch(e){r(e)}})},32043:(e,t,s)=>{s.a(e,async(e,r)=>{try{s.r(t),s.d(t,{POST:()=>A});var E=s(71309),a=s(1035),o=s(7077),i=e([a]);async function A(e){try{let{fullName:t,name:s,email:r,whatsapp:i,organization:A,subject:T,message:n}=await e.json(),R=t||s||"";if(!r||!n)return E.NextResponse.json({error:"Email et message requis."},{status:400});return await (0,a.IO)(`INSERT INTO contact_requests (full_name, email, whatsapp, organization, subject, message)
       VALUES ($1, $2, $3, $4, $5, $6)`,[R,r,i||null,A||null,T||"",n]),await (0,o.gi)(R,r,T||"Votre message"),await (0,o.cO)(R,r,i||"",A||"",T||"",n),E.NextResponse.json({success:!0,message:"Message envoy\xe9 avec succ\xe8s."})}catch(e){return console.error("Contact error:",e),E.NextResponse.json({error:"Erreur lors de la sauvegarde du message."},{status:500})}}a=(i.then?(await i)():i)[0],r()}catch(e){r(e)}})},1035:(e,t,s)=>{s.a(e,async(e,r)=>{try{s.d(t,{IO:()=>n});var E=s(8678),a=e([E]);E=(a.then?(await a)():a)[0];let o="postgres://mock:mock@localhost:5432/mock",i=!0;if(process.env.DATABASE_URL)try{new URL(process.env.DATABASE_URL),o=process.env.DATABASE_URL,i=!1,console.log("[DB] DATABASE_URL is set and valid.")}catch(e){console.error("[DB] Invalid DATABASE_URL format. Falling back to mock URL for build/safety.")}else console.warn("========================================================="),console.warn("WARNING: DATABASE_URL environment variable is missing."),console.warn("Using a mock URL for build purposes."),console.warn("=========================================================");let A=new E.default.Pool({connectionString:o,ssl:!o.includes("localhost")&&{rejectUnauthorized:!1},connectionTimeoutMillis:5e3}),T=!1,n=async(e,t)=>{if(i)return console.warn(`[DB] Mock mode active. Returning empty result for query: ${e.substring(0,50)}...`),{rows:[],rowCount:0};if(!A)throw Error("Database pool not initialized");return T||-1!==e.toLowerCase().indexOf("create table")||-1!==e.toLowerCase().indexOf("alter table")||(await R(),T=!0),await A.query(e,t)},R=async()=>{if(A&&!i)try{let e=await A.connect();try{await e.query(`
      ...
      BEGIN 
        ...
        END;
      END $$;
    `),console.log("[DB] Tables initialized successfully")}finally{e.release()}}catch(e){console.error("[DB] Initialization error:",e)}};r()}catch(e){r(e)}})},7077:(e,t,s)=>{s.d(t,{Sg:()=>E,cO:()=>o,gi:()=>a});let r=s(56742).createTransport({host:"smtp.gmail.com",port:587,secure:!1,auth:{user:process.env.EMAIL_USER,pass:process.env.EMAIL_PASS}});async function E(e,t){await r.sendMail({from:`"Bourse du Temps" <${process.env.EMAIL_USER}>`,to:e,subject:"Votre code de v\xe9rification",html:`
    ...
    `})}async function a(e,t,s=""){await r.sendMail({from:`"Bourse du Temps" <${process.env.EMAIL_USER}>`,to:t,subject:"Accus\xe9 de r\xe9ception - Bourse du Temps",html:`
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 32px; background: #f8fafc; border-radius: 12px;">
        ...
        <div style="background: white; padding: 24px; border-radius: 8px; border: 1px solid #e2e8f0;">
          ...
          <p style="color: #475569;">Nous avons bien re\xe7u votre message${s?` concernant "<strong>${s}</strong>"`:""} et nous vous r\xe9pondrons dans les plus brefs d\xe9lais.</p>
    ...
    `})}async function o(e,t,s,E,a,o){let i=process.env.EMAIL_USER;i&&await r.sendMail({from:`"Bourse du Temps" <${i}>`,to:i,subject:`Nouveau message de contact : ${a||"Sans sujet"}`,html:`
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr><td style="padding: 8px; font-weight: bold; color: #475569;">WhatsApp</td><td style="padding: 8px; color: #1e293b;">${s||"-"}</td></tr>
          ...
          <tr><td style="padding: 8px; font-weight: bold; color: #475569;">Sujet</td><td style="padding: 8px; color: #1e293b;">${a||"-"}</td></tr>
        </table>
    ...
    `})}}};var t=require("../../../webpack-runtime.js");t.C(e);var s=e=>t(t.s=e),r=t.X(0,[7787,4833,6742],()=>s(83041));module.exports=r})();