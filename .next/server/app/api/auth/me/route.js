"use strict";(()=>{var e={};e.id=8788,e.ids=[8788],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},30232:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.r(E),t.d(E,{originalPathname:()=>L,patchFetch:()=>i,requestAsyncStorage:()=>n,routeModule:()=>o,serverHooks:()=>u,staticGenerationAsyncStorage:()=>N});var T=t(73278),R=t(45002),s=t(54877),a=t(74232),r=e([a]);a=(r.then?(await r)():r)[0];let o=new T.AppRouteRouteModule({definition:{kind:R.x.APP_ROUTE,page:"/api/auth/me/route",pathname:"/api/auth/me",filename:"route",bundlePath:"app/api/auth/me/route"},resolvedPagePath:"P:\\boursedutemps\\app\\api\\auth\\me\\route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:n,staticGenerationAsyncStorage:N,serverHooks:u}=o,L="/api/auth/me/route";function i(){return(0,s.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:N})}A()}catch(e){A(e)}})},74232:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.r(E),t.d(E,{GET:()=>r});var T=t(71309),R=t(16910),s=t(1035),a=e([s]);async function r(e){let E=(0,R.b)(e);if(!E)return T.NextResponse.json({error:"Unauthorized"},{status:401});let t=await (0,s.IO)("SELECT * FROM users WHERE uid = $1",[E]);if((t.rowCount??0)===0)return T.NextResponse.json({error:"User not found"},{status:404});let A=t.rows[0],a={id:A.uid,uid:A.uid,firstName:A.first_name,lastName:A.last_name,email:A.email,department:A.department,whatsapp:A.whatsapp,gender:A.gender,country:A.country,bio:A.bio,offeredSkills:A.offered_skills||[],requestedSkills:A.requested_skills||[],availability:A.availability,languages:A.languages||[],credits:A.credits,avatar:A.avatar,coverPhoto:A.cover_photo,role:A.role,status:A.status,createdAt:A.created_at};return T.NextResponse.json(a)}s=(a.then?(await a)():a)[0],A()}catch(e){A(e)}})},16910:(e,E,t)=>{t.d(E,{b:()=>T});let A=(0,t(30311).eI)("https://ikhutkwtaqpdiosatros.supabase.co",process.env.SUPABASE_SERVICE_ROLE_KEY);async function T(e){let E=e.headers.get("authorization");if(!E?.startsWith("Bearer "))return null;let t=E.replace("Bearer ","").trim();if(!t)return null;let{data:T,error:R}=await A.auth.getUser(t);return R||!T?.user?null:T.user.id}},1035:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.d(E,{IO:()=>o});var T=t(8678),R=e([T]);T=(R.then?(await R)():R)[0];let s="postgres://mock:mock@localhost:5432/mock",a=!0;if(process.env.DATABASE_URL)try{new URL(process.env.DATABASE_URL),s=process.env.DATABASE_URL,a=!1,console.log("[DB] DATABASE_URL is set and valid.")}catch(e){console.error("[DB] Invalid DATABASE_URL format. Falling back to mock URL for build/safety.")}else console.warn("========================================================="),console.warn("WARNING: DATABASE_URL environment variable is missing."),console.warn("Using a mock URL for build purposes."),console.warn("=========================================================");let r=new T.default.Pool({connectionString:s,ssl:!s.includes("localhost")&&{rejectUnauthorized:!1},connectionTimeoutMillis:5e3}),i=!1,o=async(e,E)=>{if(a)return console.warn(`[DB] Mock mode active. Returning empty result for query: ${e.substring(0,50)}...`),{rows:[],rowCount:0};if(!r)throw Error("Database pool not initialized");return i||-1!==e.toLowerCase().indexOf("create table")||-1!==e.toLowerCase().indexOf("alter table")||(await n(),i=!0),await r.query(e,E)},n=async()=>{if(r&&!a)try{let e=await r.connect();try{await e.query(`
      ...
      BEGIN 
        ...
        END;
      END $$;
    `),console.log("[DB] Tables initialized successfully")}finally{e.release()}}catch(e){console.error("[DB] Initialization error:",e)}};A()}catch(e){A(e)}})}};var E=require("../../../../webpack-runtime.js");E.C(e);var t=e=>E(E.s=e),A=E.X(0,[7787,4833,311],()=>t(30232));module.exports=A})();