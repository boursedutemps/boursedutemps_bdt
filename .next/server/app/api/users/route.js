"use strict";(()=>{var e={};e.id=5701,e.ids=[5701],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},92154:(e,E,A)=>{A.a(e,async(e,T)=>{try{A.r(E),A.d(E,{originalPathname:()=>u,patchFetch:()=>i,requestAsyncStorage:()=>N,routeModule:()=>o,serverHooks:()=>L,staticGenerationAsyncStorage:()=>n});var t=A(73278),R=A(45002),s=A(54877),r=A(92590),a=e([r]);r=(a.then?(await a)():a)[0];let o=new t.AppRouteRouteModule({definition:{kind:R.x.APP_ROUTE,page:"/api/users/route",pathname:"/api/users",filename:"route",bundlePath:"app/api/users/route"},resolvedPagePath:"P:\\boursedutemps\\app\\api\\users\\route.ts",nextConfigOutput:"",userland:r}),{requestAsyncStorage:N,staticGenerationAsyncStorage:n,serverHooks:L}=o,u="/api/users/route";function i(){return(0,s.patchFetch)({serverHooks:L,staticGenerationAsyncStorage:n})}T()}catch(e){T(e)}})},92590:(e,E,A)=>{A.a(e,async(e,T)=>{try{A.r(E),A.d(E,{GET:()=>r});var t=A(71309),R=A(1035),s=e([R]);async function r(){try{let e=(await (0,R.IO)("SELECT * FROM users WHERE status != $1 ORDER BY created_at DESC",["deleted"])).rows.map(e=>({id:e.uid,uid:e.uid,firstName:e.first_name,lastName:e.last_name,email:e.email,department:e.department,whatsapp:e.whatsapp,gender:e.gender,country:e.country,bio:e.bio,offeredSkills:e.offered_skills||[],requestedSkills:e.requested_skills||[],availability:e.availability,languages:e.languages||[],credits:e.credits,avatar:e.avatar,coverPhoto:e.cover_photo,role:e.role,status:e.status,createdAt:e.created_at}));return t.NextResponse.json(e)}catch(e){return console.error("Error fetching users:",e),t.NextResponse.json({error:"Internal Server Error"},{status:500})}}R=(s.then?(await s)():s)[0],T()}catch(e){T(e)}})},1035:(e,E,A)=>{A.a(e,async(e,T)=>{try{A.d(E,{IO:()=>o});var t=A(8678),R=e([t]);t=(R.then?(await R)():R)[0];let s="postgres://mock:mock@localhost:5432/mock",r=!0;if(process.env.DATABASE_URL)try{new URL(process.env.DATABASE_URL),s=process.env.DATABASE_URL,r=!1,console.log("[DB] DATABASE_URL is set and valid.")}catch(e){console.error("[DB] Invalid DATABASE_URL format. Falling back to mock URL for build/safety.")}else console.warn("========================================================="),console.warn("WARNING: DATABASE_URL environment variable is missing."),console.warn("Using a mock URL for build purposes."),console.warn("=========================================================");let a=new t.default.Pool({connectionString:s,ssl:!s.includes("localhost")&&{rejectUnauthorized:!1},connectionTimeoutMillis:5e3}),i=!1,o=async(e,E)=>{if(r)return console.warn(`[DB] Mock mode active. Returning empty result for query: ${e.substring(0,50)}...`),{rows:[],rowCount:0};if(!a)throw Error("Database pool not initialized");return i||-1!==e.toLowerCase().indexOf("create table")||-1!==e.toLowerCase().indexOf("alter table")||(await N(),i=!0),await a.query(e,E)},N=async()=>{if(a&&!r)try{let e=await a.connect();try{await e.query(`
      ...
      BEGIN 
        ...
        END;
      END $$;
    `),console.log("[DB] Tables initialized successfully")}finally{e.release()}}catch(e){console.error("[DB] Initialization error:",e)}};T()}catch(e){T(e)}})}};var E=require("../../../webpack-runtime.js");E.C(e);var A=e=>E(E.s=e),T=E.X(0,[7787,4833],()=>A(92154));module.exports=T})();