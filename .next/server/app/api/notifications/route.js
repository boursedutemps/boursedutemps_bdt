"use strict";(()=>{var e={};e.id=1996,e.ids=[1996],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},8678:e=>{e.exports=import("pg")},26484:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.r(E),t.d(E,{originalPathname:()=>L,patchFetch:()=>i,requestAsyncStorage:()=>n,routeModule:()=>o,serverHooks:()=>u,staticGenerationAsyncStorage:()=>N});var T=t(73278),R=t(45002),s=t(54877),a=t(72233),r=e([a]);a=(r.then?(await r)():r)[0];let o=new T.AppRouteRouteModule({definition:{kind:R.x.APP_ROUTE,page:"/api/notifications/route",pathname:"/api/notifications",filename:"route",bundlePath:"app/api/notifications/route"},resolvedPagePath:"P:\\boursedutemps\\app\\api\\notifications\\route.ts",nextConfigOutput:"",userland:a}),{requestAsyncStorage:n,staticGenerationAsyncStorage:N,serverHooks:u}=o,L="/api/notifications/route";function i(){return(0,s.patchFetch)({serverHooks:u,staticGenerationAsyncStorage:N})}A()}catch(e){A(e)}})},72233:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.r(E),t.d(E,{DELETE:()=>o,GET:()=>r,PATCH:()=>i});var T=t(71309),R=t(16910),s=t(1035),a=e([s]);async function r(e){let E=await (0,R.b)(e);if(!E)return T.NextResponse.json({error:"Non autoris\xe9"},{status:401});let t=await (0,s.IO)("SELECT * FROM notifications WHERE user_id = $1 ORDER BY created_at DESC LIMIT 30",[E]);return T.NextResponse.json(t.rows)}async function i(e){let E=await (0,R.b)(e);if(!E)return T.NextResponse.json({error:"Non autoris\xe9"},{status:401});let{id:t}=await e.json();return t?await (0,s.IO)("UPDATE notifications SET read = true WHERE id = $1 AND user_id = $2",[t,E]):await (0,s.IO)("UPDATE notifications SET read = true WHERE user_id = $1",[E]),T.NextResponse.json({success:!0})}async function o(e){let E=await (0,R.b)(e);return E?(await (0,s.IO)("DELETE FROM notifications WHERE user_id = $1 AND read = true",[E]),T.NextResponse.json({success:!0})):T.NextResponse.json({error:"Non autoris\xe9"},{status:401})}s=(a.then?(await a)():a)[0],A()}catch(e){A(e)}})},16910:(e,E,t)=>{t.d(E,{b:()=>T});let A=(0,t(30311).eI)("https://ikhutkwtaqpdiosatros.supabase.co",process.env.SUPABASE_SERVICE_ROLE_KEY);async function T(e){let E=e.headers.get("authorization");if(!E?.startsWith("Bearer "))return null;let t=E.replace("Bearer ","").trim();if(!t)return null;let{data:T,error:R}=await A.auth.getUser(t);return R||!T?.user?null:T.user.id}},1035:(e,E,t)=>{t.a(e,async(e,A)=>{try{t.d(E,{IO:()=>o});var T=t(8678),R=e([T]);T=(R.then?(await R)():R)[0];let s="postgres://mock:mock@localhost:5432/mock",a=!0;if(process.env.DATABASE_URL)try{new URL(process.env.DATABASE_URL),s=process.env.DATABASE_URL,a=!1,console.log("[DB] DATABASE_URL is set and valid.")}catch(e){console.error("[DB] Invalid DATABASE_URL format. Falling back to mock URL for build/safety.")}else console.warn("========================================================="),console.warn("WARNING: DATABASE_URL environment variable is missing."),console.warn("Using a mock URL for build purposes."),console.warn("=========================================================");let r=new T.default.Pool({connectionString:s,ssl:!s.includes("localhost")&&{rejectUnauthorized:!1},connectionTimeoutMillis:5e3}),i=!1,o=async(e,E)=>{if(a)return console.warn(`[DB] Mock mode active. Returning empty result for query: ${e.substring(0,50)}...`),{rows:[],rowCount:0};if(!r)throw Error("Database pool not initialized");return i||-1!==e.toLowerCase().indexOf("create table")||-1!==e.toLowerCase().indexOf("alter table")||(await n(),i=!0),await r.query(e,E)},n=async()=>{if(r&&!a)try{let e=await r.connect();try{await e.query(`
      ...
      BEGIN 
        ...
        END;
      END $$;
    `),console.log("[DB] Tables initialized successfully")}finally{e.release()}}catch(e){console.error("[DB] Initialization error:",e)}};A()}catch(e){A(e)}})}};var E=require("../../../webpack-runtime.js");E.C(e);var t=e=>E(E.s=e),A=E.X(0,[7787,4833,311],()=>t(26484));module.exports=A})();